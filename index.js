...
// Reseni a poznamky od Oleksie:
// const createAccount = (user, generatePassword) => {  // Napište funkci createAccount, která se bude tvářit, že zakládá nový uživatelský účet. Funkce bude mít dva parametry user a generatePassword. První bude uživatelské jméno a druhý bude funkce,
//   const password = generatePassword(9); // 9- znamená počet znaků v našem hesle
//   return `Uživatel ${user} s heslem ${password}.`;
// };
// document.body.innerHTML += `
//      <p>${createAccount('Míša', weakPassword)}</p>`; //Zde při volání funkce createAccount první parametr bude user a druhý generatePassword - který nabývá hodnoty weakPassword, mediumPassword nebo strongPassword z počet znaků 9